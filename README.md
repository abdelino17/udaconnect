...
3. `kubectl apply -f deployment/kafka-configmap.yaml` - Set up kafka config
...
- `http://localhost:30001/` - OpenAPI Documentation for Locations API
- `http://localhost:30001/api/` - Base path for locations API
- `http://localhost:30002/` - gRPC Locations API
